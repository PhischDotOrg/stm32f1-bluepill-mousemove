...
extern const ::usb::UsbDeviceDescriptor_t usbDeviceDescriptor FIXED_DATA = {
    ...
    .m_idVendor             = { 0x47, 0x11 },                                           /* m_idVendor */
    .m_idProduct            = { 0x23, 0x42 },                                           /* m_idProduct */
...
static const auto usbStringDescriptorSerialNumber   FIXED_DATA  = ::usb::UsbStringDescriptor(u"9ABFDA06-960A-4397-A298-7D271938999F");
static const auto usbStringDescriptorProduct        FIXED_DATA  = ::usb::UsbStringDescriptor(u"PhiSch.org USB Human Interface Device (HID) Demo v2.0 on STM32F103");
